## Product Hunt Plugin Guide

This plugin provides trending Product Hunt data as a Dify tool. You can use it in your Dify workflows or bots to fetch and display trending products from Product Hunt.
